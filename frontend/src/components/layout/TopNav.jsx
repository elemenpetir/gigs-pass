...
const TopNav = forwardRef(
  ({ logo, links = [], right, className, ...props }, ref) => (
    <header
      className={cn(
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between p-4 md:px-8">
        <div className="flex items-center gap-8 md:gap-12 mb-4 md:mb-0">
          {logo ? (
            ...
            <a
              href="/"
              className="text-3xl md:text-5xl font-black tracking-tighter leading-none flex items-center"
            >
              <span className="bg-foreground text-background px-2 py-1 brut-border-2 border-transparent -rotate-2 mr-1">
                GIGS
              </span>
